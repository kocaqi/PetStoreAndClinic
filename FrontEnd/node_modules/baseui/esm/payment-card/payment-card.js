...
var _excluded = ["overrides", "size", "onChange", "value", "aria-label"],
    _excluded2 = ["IconWrapper"];
...
var PaymentCard = /*#__PURE__*/function (_React$Component) {
  ...
  function PaymentCard(props) {
    ...
    CUSTOM_CARDS_CONFIGURATION.forEach(function (cardTypeConfig) {
      return (// @ts-expect-error todo(flow-ts) upgrade card-validator dependency
  ...
  _createClass(PaymentCard, [{
    ...
    value: function render() {
      ...
      var IconWrapperOverride = overrides.IconWrapper,
          restOverrides = _objectWithoutProperties(overrides, _excluded2);

      var _getOverrides = getOverrides(IconWrapperOverride, StyledIconWrapper),
          _getOverrides2 = _slicedToArray(_getOverrides, 2),
          IconWrapper = _getOverrides2[0],
          iconWrapperProps = _getOverrides2[1]; // todo(flow->ts): maybe incorrect typecast, should it be `${value}`?
          ...
          React.createElement(Input, _extends({
            ...
            onChange: function onChange(e) {
              var _getCaretPosition = getCaretPosition(e.target.value, _this2.props.value ? String(_this2.props.value) : '', e.target.selectionStart),
                  ...
                  value = _getCaretPosition2[1]; // @ts-expect-error todo(flow->ts): looks dangerous


              _this2.caretPosition = position;
              _this2.inRef = e.target; // @ts-expect-error todo(flow->ts): looks dangerous
