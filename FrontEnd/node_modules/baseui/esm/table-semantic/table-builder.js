...
var _excluded = ["overrides", "children", "data", "divider", "horizontalScrollWidth", "sortColumn", "sortOrder", "onSort", "isLoading", "loadingMessage", "emptyMessage", "size"];
...
var TableBuilder = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(TableBuilder, [{
    ...
    value: function render() {
      ...
      var columns = React.Children.toArray(children).filter(Boolean) // @ts-expect-error todo(flow->ts): limit children to be only react elements
      .map(function (child) {
        return child.props;
      });
