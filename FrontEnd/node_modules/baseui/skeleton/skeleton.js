...
var Skeleton = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Skeleton, [{
    ...
    value: function render() {
      ...
      var _getOverrides3 = (0, _overrides.getOverrides)(overrides.Row, _styledComponents.StyledRow),
          _getOverrides4 = _slicedToArray(_getOverrides3, 2),
          Row = _getOverrides4[0],
          rowProps = _getOverrides4[1];
      ...
      if (typeof this.props.rows === 'number') {
        return /*#__PURE__*/React.createElement(Root, _extends({
          ...
          testid: 'loader'
        }, rootProps), Array(this.props.rows).fill(undefined).map(function (item, index) {
          return /*#__PURE__*/React.createElement(Row, _extends({
            $animation: _this.props.animation,
            key: index,
            $isLastRow: index === _this.props.rows - 1
          }, rowProps));
        }));
      }
