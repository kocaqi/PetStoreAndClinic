...
export function ShopInformation(props) {
    ...
    async function setShopData(user_id){
        ...
        const shopData = await getShopData(userData.shop_id)
                    ...
                    <div style={FormRow}>
                        ...
                        <div style={FormInputContainer}>
                            <div>
                                ...
                                {
                                    props.type=="view"
                                    ? <input type="text" name="shop_id"  placeholder={formik.values["shop_id"]} value={formik.values['shop_id']} onChange={formik.handleChange} style={FormInput} readonly="true"/>
                                    : <input type="text" name="shop_id"  placeholder={formik.values["shop_id"]} value={formik.values['shop_id']} onChange={formik.handleChange} style={FormInput} />
                                }
                            </div>
                        </div>
                        <div style={FormInputContainer}>
                            <div>
                                ...
                                {
                                    props.type=="view"
                                    ? <input name="shopName" type="text" placeholder="Shop Name" value={formik.values['shopName']} onChange={formik.handleChange} style={FormInput} readonly="true"/>
                                    : <input name="shopName" type="text" placeholder="Shop Name" value={formik.values['shopName']} onChange={formik.handleChange} style={FormInput} readonly="true"/>
                                }
                            </div>
                        </div>
