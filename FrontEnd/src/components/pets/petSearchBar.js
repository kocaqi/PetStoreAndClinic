...
export function PetSearchBar(props) {
      ...
      return (
            <div style={outerContainer}>
                  ...
                  <div style={searchNavContainer}>
                    <input placeholder='Name' style={Input} name="name" value={formik.values.name} onChange={formik.handleChange} />
                    <input placeholder='Pet ID' style={Input} name="id" value={formik.values.id} onChange={formik.handleChange} />
