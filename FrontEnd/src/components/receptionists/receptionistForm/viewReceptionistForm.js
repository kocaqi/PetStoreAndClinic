...
function FormCurrentPage(props){
    if(props.current==1)
        return (<ReceptionistInformation type={props.props.type} user_id={props.props.user_id} onClose={props.props.onClose}/>)
...
export function ViewReceptionistForm(props) {
            ...
            <div>
                ...
                <div style={Container}>
                    <div style={TabContainer}>
                        <ul style={TabList}>
                            <li style={currentTab==1 ? {...Tab, ...ActiveTab} : Tab} onClick={() => setCurrentTab(1)}>Receptionist Information</li>
