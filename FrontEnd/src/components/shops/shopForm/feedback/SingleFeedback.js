            ...
            <td style={textField}>
              <div style={title}>
                <div >
                  <div>
                    <div>
                      <h5 style={name}><a href="#" style={{"text-decoration": "none", "color": "#2d3b55"}} onClick={(e) => props.onPageChange(e , <FeedbackForm feedback_id={props.feedback_data.id} type={props.type} onClose={props.onClose}/>)}>{props.feedback_data["title"]}</a></h5>
                    </div>
                  </div>
                </div>
              </div>
