...
var _i18nInterpolation = _interopRequireDefault(require("../helpers/i18n-interpolation"));
...
var Datepicker = /*#__PURE__*/function (_React$Component) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onCalendarSelect", function (data) {
      ...
      if (Array.isArray(nextDate) && _this.props.range) {
        if (!nextDate[0] || !nextDate[1]) {
          ...
          } else if (_this.dateHelpers.dateRangeIncludesDates(nextDate, _this.props.excludeDates)) {
            nextDate = _this.props.value;
            isOpen = true;
          }
  ...
  _createClass(Datepicker, [{
    ...
    value: function renderInputComponent(locale, inputRole) {
      ...
      var _getOverrides = (0, _overrides.getOverrides)(overrides.Input, _input.MaskedInput),
    ...
    value: function render() {
      ...
      var _getOverrides3 = (0, _overrides.getOverrides)(overrides.Popover, _popover.Popover),
      ...
      return /*#__PURE__*/React.createElement(_locale.LocaleContext.Consumer, null, function (locale) {
        ...
        _this4.props.value[0] && _this4.props.value[1] ? (0, _i18nInterpolation.default)(locale.datepicker.selectedDateRange, {
          ...
          endDate: _this4.formatDisplayValue(_this4.props.value[1])
