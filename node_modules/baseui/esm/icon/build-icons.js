      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        iconExports.push("export {default as ".concat(componentName, "} from './").concat(svgFile, "';"));
                        ...
                        fs.writeFileSync(path.resolve(__dirname, "./".concat(svgFile, ".tsx")), prettier.format(result, _objectSpread({
                          parser: 'typescript'
                        }, prettierOptions)));
            ...
            fs.writeFileSync(path.resolve(__dirname, "./icon-exports.ts"), "/*\nCopyright (c) Uber Technologies, Inc.\n\nThis source code is licensed under the MIT license found in the\nLICENSE file in the root directory of this source tree.\n*/\n".concat(iconExports.join('\n'), "\n")); // eslint-disable-next-line no-console
