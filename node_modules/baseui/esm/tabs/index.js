...
export { default as Tab } from './tab'; // Constants

export { ORIENTATION, STATE_CHANGE_TYPE } from './constants'; // Styled elements

export { Root as StyledRoot, Tab as StyledTab, TabBar as StyledTabBar, TabContent as StyledTabContent } from './styled-components'; // Flow
