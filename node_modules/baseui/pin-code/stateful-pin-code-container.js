...
var StatefulPinCodeContainer = /*#__PURE__*/function (_React$Component) {
  _inherits(StatefulPinCodeContainer, _React$Component);

  var _super = _createSuper(StatefulPinCodeContainer);
  ...
  function StatefulPinCodeContainer() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleChange", function (_ref) {
      ...
      var nextState = _this.props.stateReducer(_input.STATE_CHANGE_TYPE.change, {
        values: values
      }, _this.state);
