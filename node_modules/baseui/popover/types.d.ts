...
export declare type AccessibilityType = keyof typeof ACCESSIBILITY_TYPE;
export declare type State = {
    isOpen: boolean;
};
export declare type StateChangeType = keyof typeof STATE_CHANGE_TYPE;
export declare type StateReducer = (stateChangeType: StateChangeType, nextState: State, currentState: State) => State;
export declare type ContentRenderProp = () => React.ReactNode;
export declare type StatefulContentRenderProp = (a: {
    close: () => void;
}) => React.ReactNode;
export declare type PopoverOverrides = {
    Body?: Override;
    Arrow?: Override;
    Inner?: Override;
};
...
export declare type PopoverProps = BasePopoverProps & {
...
export declare type StatefulPopoverProps = BasePopoverProps & {
    /** Content that should trigger the popover to be shown (also acts as the anchor against
     * which the popover will be positioned).
     */
    children: React.ReactNode;
...
export declare type StatefulPopoverContainerProps = Omit<StatefulPopoverProps, 'children'> & {
    children: (props: Omit<PopoverProps, 'children'>) => React.ReactNode;
};
export declare type PopoverPropsWithoutChildren = Omit<PopoverProps, 'children'>;
export declare type Offset = {
    top: number;
    left: number;
};
export declare type PopoverPrivateState = {
    isAnimating: boolean;
    arrowOffset: Offset;
...
export declare type ArrowStylePropsArg = {
    $arrowOffset: Offset;
    $placement: TetherPlacement;
};
export declare type BodyStylePropsArg = {
...
export declare type InnerStylePropsArg = {};
export declare type SharedStylePropsArg = {} & ArrowStylePropsArg & BodyStylePropsArg;
