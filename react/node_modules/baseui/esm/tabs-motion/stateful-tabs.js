var _excluded = ["children", "initialState", "stateReducer", "onChange"];
...
var getInitialState = function getInitialState(children, initialState) {
  if (initialState && initialState.activeKey) {
    ...
    var firstKey = React.Children.map(children, // @ts-expect-error todo(flow->ts) child might be not a ReactElement, theoretically including null
